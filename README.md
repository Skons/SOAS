...
* [[Changelog](changelog.md)](#Changelogchangelog.md)
...
Switch the local alarm on, mainly for testing purposes. Disable this function by setting the substitution `top_button_double_press_enabled` to false.

### <a name='Topbuttontriplepress'></a>Top button triple press

Switch the alarm on, mainly for testing purposes. Disable this function by setting the substitution `top_button_triple_press_enabled` to false.

### <a name='Topbuttonlongpress'></a>Top button long press

Just play music. This switches off the alarm and snooze, and does not enable the sleep timer. Disable this function by setting the substitution `top_button_long_press_enabled` to false.
...
* A local MP3 file does not play - https://github.com/Skons/SOAS/issues/55#issuecomment-4558008621

## <a name='Changelogchangelog.md'></a>[Changelog](changelog.md)
